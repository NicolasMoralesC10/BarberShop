...
(function (d) {
  ...
  d.extend(x.prototype, {
    ...
    _expandButton: function (a, b, c, e, h, f, g) {
      ...
      for (var q = r.length; c < q; c++) {
        ...
        if (n)
          if (((b = n.config !== p && n.config.split ? !0 : !1), Array.isArray(n)))
            this._expandButton(
              a,
              n,
            ...
            if (k) {
              ...
              if (k.conf.buttons || k.conf.split) {
                k.collection = d(
                  "<" + (b ? this.c.dom.splitCollection.tag : this.c.dom.collection.tag) + "/>"
                );
                  ...
                  for (var t = 0; t < k.conf.split.length; t++)
                    "object" === typeof k.conf.split[t] &&
                      ...
                      k.conf.split[t].collectionLayout === p &&
                        (k.conf.split[t].collectionLayout = k.conf.collectionLayout),
                      k.conf.split[t].dropup === p && (k.conf.split[t].dropup = k.conf.dropup),
                      k.conf.split[t].fade === p && (k.conf.split[t].fade = k.conf.fade));
                else
                  d(k.node).append(
                    d('<span class="dt-down-arrow">' + this.c.dom.splitDropdown.text + "</span>")
                  );
      ...
      if (a.hasOwnProperty("html")) var k = d(a.html);
        ...
        k = d("<" + g + "/>")
          ...
          .on("keypress.dtb", function (v) {
            13 === v.keyCode &&
              (v.preventDefault(), !k.hasClass(h.disabled) && a.action && t(v, r, k, a));
          });
    ...
    _popover: function (a, b, c, e) {
      ...
      var h = !1,
        ...
        l = function () {
          ...
          d(b.buttons('[aria-haspopup="dialog"][aria-expanded="true"]').nodes()).attr(
            "aria-expanded",
            "false"
          );
      ...
      if (!1 === a) l();
        ...
        f.popoverTitle
          ? m.prepend('<div class="dt-button-collection-title">' + f.popoverTitle + "</div>")
          : f.collectionTitle &&
            m.prepend('<div class="dt-button-collection-title">' + f.collectionTitle + "</div>");
        f.closeButton &&
          m.prepend('<div class="dtb-popover-close">x</div>').addClass("dtb-collection-closeable");
        ...
        if ("absolute" === r) {
          ...
          if ("dt-container" === f.align || "container" === f.align)
            y < c.left && (y = -c.left), y + w.width > n.width && (y = n.width - w.width);
          ...
          d("body")
            .on("click.dtb-collection", function (B) {
              if (!h) {
                ...
                ((!d(B.target).parents()[z]().filter(a).length && !d(v).hasClass("dt-buttons")) ||
            ...
            .on("keydown.dtb-collection", function (B) {
              ...
              9 === B.keyCode &&
                (-1 === z.index(v)
                  ...
                  : v === z.last()[0] && (z.first().focus(), B.preventDefault()));
            });
        }, 0);
      }
    },
      ...
      var c = [],
        ...
        h = function (l, m) {
          ...
          if (Array.isArray(l) || l instanceof d) for (n = 0, r = l.length; n < r; n++) h(l[n], m);
            ...
            "object" === typeof l &&
              l.nodeName &&
              ((q = d.inArray(l, n)), -1 !== q && c.push({ inst: m, node: n[q] }));
        },
        f = 0,
        g = a.length;
      f < g;
  ...
  u.Api.register("button().add()", function (a, b, c) {
    var e = this.context;
    e.length &&
      ((e = x.instanceSelector(this._groupSelector, e[0]._buttons)), e.length && e[0].add(b, a, c));
  ...
  u.Api.register("buttons.exportInfo()", function (a) {
    ...
    c === p || null === c
      ? (c = null)
      : (-1 !== c.indexOf("*") && (c = c.replace("*", d("head > title").text()).trim()),
